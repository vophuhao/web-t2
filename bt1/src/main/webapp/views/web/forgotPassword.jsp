		...
		<div class="container">
			<label for="username"><input type="text"
				placeholder="Username" name="username" required></label> 
				 <label for="email"> <input type="text" placeholder="Email" name="email" required></label> 
				 <label for="password"> <input
				type="password" placeholder="New Password" name="password" required></label>
			...
			<a href="/vn.iostart/login">Login</a>
		</div>
	</form>
</body>
</html>